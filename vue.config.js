...
module.exports = {
  pages: {
    index: {
      ...
      fileName: 'index.html',
      title: 'Sistema de evaluación a distancia',
      description: 'Sistema desarrollado por el Ministerio de Educación y la Agencia de Gobierno Electrónico y Tecnologías de la Información para realizar las olimpiadas plurinacionales',
